...
class CalendarEventForm(BaseModel):
    ...
    attendees: Optional[List[Optional[Dict[str, Any]]]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["calendar_id", "title", "description", "start_at", "end_at", "all_day", "rrule", "color", "location", "data", "meta", "attendees"]
