...
class UserGroupIdsModel(BaseModel):
    """
    UserGroupIdsModel
    """ # noqa: E501
    id: StrictStr
    ...
    role: Optional[StrictStr] = 'pending'
    name: StrictStr
    profile_image_url: Optional[StrictStr] = None
    profile_banner_image_url: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "email", "username", "role", "name", "profile_image_url", "profile_banner_image_url", "bio", "gender", "date_of_birth", "timezone", "presence_state", "status_emoji", "status_message", "status_expires_at", "info", "settings", "oauth", "scim", "last_active_at", "updated_at", "created_at", "group_ids"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if profile_banner_image_url (nullable) is None
        # and model_fields_set contains the field
        if self.profile_banner_image_url is None and "profile_banner_image_url" in self.model_fields_set:
            _dict['profile_banner_image_url'] = None
        ...
        # set to None if scim (nullable) is None
        # and model_fields_set contains the field
        if self.scim is None and "scim" in self.model_fields_set:
            _dict['scim'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "role": obj.get("role") if obj.get("role") is not None else 'pending',
            "name": obj.get("name"),
            "profile_image_url": obj.get("profile_image_url"),
            "profile_banner_image_url": obj.get("profile_banner_image_url"),
            "bio": obj.get("bio"),
