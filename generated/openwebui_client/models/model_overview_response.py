...
class ModelOverviewResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["history", "tags"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "history": [HistoryEntry.from_dict(_item) for _item in obj["history"]] if obj.get("history") is not None else None,
            "tags": [TagEntry.from_dict(_item) for _item in obj["tags"]] if obj.get("tags") is not None else None
        })
