...
class AudioConfigUpdateForm(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["tts", "stt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tts": TTSConfigForm.from_dict(obj["tts"]) if obj.get("tts") is not None else None,
            "stt": STTConfigForm.from_dict(obj["stt"]) if obj.get("stt") is not None else None
        })
