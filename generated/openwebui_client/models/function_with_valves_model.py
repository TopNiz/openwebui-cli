...
class FunctionWithValvesModel(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "user_id", "name", "type", "content", "meta", "valves", "is_active", "is_global", "updated_at", "created_at"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if valves (nullable) is None
        # and model_fields_set contains the field
        if self.valves is None and "valves" in self.model_fields_set:
            _dict['valves'] = None
