...
class FeedbackForm(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["type", "data", "meta", "snapshot"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "data": RatingData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "meta": obj.get("meta"),
            "snapshot": SnapshotData.from_dict(obj["snapshot"]) if obj.get("snapshot") is not None else None
        })
