...
class CalendarEventUserResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "calendar_id", "user_id", "title", "description", "start_at", "end_at", "all_day", "rrule", "color", "location", "data", "meta", "is_cancelled", "attendees", "created_at", "updated_at", "user"]
