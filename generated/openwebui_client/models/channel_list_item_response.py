...
class ChannelListItemResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "user_id", "type", "name", "description", "is_private", "data", "meta", "access_grants", "created_at", "updated_at", "updated_by", "archived_at", "archived_by", "deleted_at", "deleted_by", "user_ids", "users", "last_message_at", "unread_count"]
