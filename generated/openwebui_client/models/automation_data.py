...
class AutomationData(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["prompt", "model_id", "rrule", "terminal"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rrule": obj.get("rrule"),
            "terminal": AutomationTerminalConfig.from_dict(obj["terminal"]) if obj.get("terminal") is not None else None
        })
