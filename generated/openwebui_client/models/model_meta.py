...
class ModelMeta(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["profile_image_url", "description", "capabilities", "knowledge"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if knowledge (nullable) is None
        # and model_fields_set contains the field
        if self.knowledge is None and "knowledge" in self.model_fields_set:
            _dict['knowledge'] = None
