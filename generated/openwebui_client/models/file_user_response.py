...
class FileUserResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "user_id", "hash", "filename", "data", "meta", "created_at", "updated_at", "user"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": obj.get("data"),
            "meta": FileMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
