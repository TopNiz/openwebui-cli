...
class SyncFunctionsForm(BaseModel):
    ...
    SyncFunctionsForm
    """ # noqa: E501
    functions: Optional[List[FunctionWithValvesModel]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "functions": [FunctionWithValvesModel.from_dict(_item) for _item in obj["functions"]] if obj.get("functions") is not None else None
        })
