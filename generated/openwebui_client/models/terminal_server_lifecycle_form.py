...
class TerminalServerLifecycleForm(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["url", "key", "auth_type", "policy_id", "lifecycle_data"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if lifecycle_data (nullable) is None
        # and model_fields_set contains the field
        if self.lifecycle_data is None and "lifecycle_data" in self.model_fields_set:
            _dict['lifecycle_data'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "lifecycle_data": obj.get("lifecycle_data")
        })
