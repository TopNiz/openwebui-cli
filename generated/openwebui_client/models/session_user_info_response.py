...
class SessionUserInfoResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["status_emoji", "status_message", "status_expires_at", "id", "name", "role", "email", "profile_image_url", "token", "token_type", "expires_at", "permissions", "bio", "gender", "date_of_birth"]
