...
class UpdateMemoriesForm(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["operations", "source"]
    ...
    def source_validate_enum(cls, value):
        ...
        if value not in set(['tool', 'background_review']):
            raise ValueError("must be one of enum values ('tool', 'background_review')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "operations": [MemoryOperationModel.from_dict(_item) for _item in obj["operations"]] if obj.get("operations") is not None else None,
