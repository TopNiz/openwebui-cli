...
class TokenUsageResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["models", "total_input_tokens", "total_output_tokens", "total_tokens"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "models": [TokenUsageEntry.from_dict(_item) for _item in obj["models"]] if obj.get("models") is not None else None,
