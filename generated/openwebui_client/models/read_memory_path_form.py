...
class ReadMemoryPathForm(BaseModel):
    ...
    include_children: Optional[StrictBool] = True
    limit: Optional[StrictInt] = 50
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["path", "type", "include_children", "limit"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['user', 'context', 'all']):
            raise ValueError("must be one of enum values ('user', 'context', 'all')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "include_children": obj.get("include_children") if obj.get("include_children") is not None else True,
