...
class KnowledgeFileListResponse(BaseModel):
    ...
    directories: Optional[List[KnowledgeDirectoryModel]] = None
    breadcrumbs: Optional[List[KnowledgeDirectoryModel]] = None
    total: StrictInt
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["items", "directories", "breadcrumbs", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [FileUserResponse.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "directories": [KnowledgeDirectoryModel.from_dict(_item) for _item in obj["directories"]] if obj.get("directories") is not None else None,
            "breadcrumbs": [KnowledgeDirectoryModel.from_dict(_item) for _item in obj["breadcrumbs"]] if obj.get("breadcrumbs") is not None else None,
            "total": obj.get("total")
        })
