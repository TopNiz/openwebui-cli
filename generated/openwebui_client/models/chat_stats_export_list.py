...
class ChatStatsExportList(BaseModel):
    ...
    ChatStatsExportList
    """ # noqa: E501
    type: Optional[StrictStr] = 'chats'
    items: List[ChatStatsExport]
    total: StrictInt
    page: StrictInt
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["type", "items", "total", "page"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else 'chats',
            "items": [ChatStatsExport.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "total": obj.get("total"),
            "page": obj.get("page")
        })
