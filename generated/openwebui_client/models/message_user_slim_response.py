...
class MessageUserSlimResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "user_id", "channel_id", "reply_to_id", "parent_id", "is_pinned", "pinned_by", "pinned_at", "content", "data", "meta", "created_at", "updated_at", "user"]
