...
class FolderNameIdResponse(BaseModel):
    ...
    is_expanded: Optional[StrictBool] = False
    unread_count: Optional[StrictInt] = 0
    created_at: StrictInt
    updated_at: StrictInt
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "name", "meta", "parent_id", "is_expanded", "unread_count", "created_at", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "meta": FolderMetadataResponse.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "parent_id": obj.get("parent_id"),
            "is_expanded": obj.get("is_expanded") if obj.get("is_expanded") is not None else False,
