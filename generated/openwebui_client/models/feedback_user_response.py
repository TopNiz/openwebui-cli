...
class FeedbackUserResponse(BaseModel):
    ...
    user: Optional[OpenWebuiModelsFeedbacksUserResponse] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "user_id", "version", "type", "data", "meta", "created_at", "updated_at", "user"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "user": OpenWebuiModelsFeedbacksUserResponse.from_dict(obj["user"]) if obj.get("user") is not None else None
        })
