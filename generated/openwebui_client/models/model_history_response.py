...
class ModelHistoryResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["model_id", "history"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "history": [ModelHistoryEntry.from_dict(_item) for _item in obj["history"]] if obj.get("history") is not None else None
        })
