...
class PushModelForm(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["model", "insecure", "stream"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if insecure (nullable) is None
        # and model_fields_set contains the field
        if self.insecure is None and "insecure" in self.model_fields_set:
            _dict['insecure'] = None
