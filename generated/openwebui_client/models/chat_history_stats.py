...
class ChatHistoryStats(BaseModel):
    ...
    current_id: Optional[StrictStr] = Field(default=None, alias="currentId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["messages", "currentId"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if current_id (nullable) is None
        # and model_fields_set contains the field
        if self.current_id is None and "current_id" in self.model_fields_set:
            _dict['currentId'] = None
