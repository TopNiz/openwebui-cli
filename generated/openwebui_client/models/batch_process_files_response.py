...
class BatchProcessFilesResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [BatchProcessFilesResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
            "errors": [BatchProcessFilesResult.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
