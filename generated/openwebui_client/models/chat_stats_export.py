...
class ChatStatsExport(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "user_id", "created_at", "updated_at", "tags", "stats", "chat"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tags": obj.get("tags"),
            "stats": AggregateChatStats.from_dict(obj["stats"]) if obj.get("stats") is not None else None,
            "chat": ChatBody.from_dict(obj["chat"]) if obj.get("chat") is not None else None
        })
